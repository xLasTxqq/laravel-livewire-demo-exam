<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden md:flex md:items-center md:ml-6">
                ...
                @guest
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 md:flex">
                    <x-dropdown-link class="rounded-full" :href="route('login')" :active="request()->routeIs('login')">
                        {{ __('Логин') }}
                    </x-dropdown-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 md:flex">
                    <x-dropdown-link class="rounded-full" :href="route('register')" :active="request()->routeIs('register')">
                        {{ __('Регистрация') }}
                    </x-dropdown-link>
                </div>
                @endguest
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('poster')" :active="request()->routeIs('poster')">
                {{ __('Афиша') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
